...
def create_batched_envs(model: mujoco.MjModel, num_envs: int) -> tuple[Any, Any]:
...
def batched_step(num_envs: int, mjx_model: Any, batched_data: Any, actions: Any) -> Any:
...
def compute_reward(batched_data: Any, model: mujoco.MjModel) -> Any:
...
def run_benchmark(model: mujoco.MjModel, num_envs: int, episode_length: int) -> float:
