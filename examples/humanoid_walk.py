...
def render_frames(model: mujoco.MjModel, data: mujoco.MjData, n_frames: int = 60) -> None:
...
def benchmark_cpu(model: mujoco.MjModel, data: mujoco.MjData, n_steps: int = 10_000) -> float:
...
def benchmark_gpu(model: mujoco.MjModel, data: mujoco.MjData, n_steps: int = 10_000) -> float:
